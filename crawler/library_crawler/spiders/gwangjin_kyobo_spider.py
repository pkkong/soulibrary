...
class GwangjinKyoboSpider(scrapy.Spider):
    name = "gwangjin_kyobo"
    allowed_domains = ["ebook.gwangjinlib.seoul.kr"]
    
    # 광진구 소장형 (교보 신버전)
    base_url = "https://ebook.gwangjinlib.seoul.kr/elibrary-front/content/contentList.ink"
    ...
    def parse(self, response):
        ...
        if page % 10 == 0:
            print(f"--- [광진구(소장)] Page {page}: {len(books)}권 수집 중 ---")
